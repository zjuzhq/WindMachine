...
public class NewDataActivity extends AppCompatActivity {
    ...
    private String filename2=Environment.getExternalStorageDirectory().getPath() + "/acc2.txt";
...
//                }
                try {
                    URL url = new URL("http://111.231.62.68/Required_data/1/SH_Acc_list/");
...
//                        showPic1();
                        ...
                        intent.setData(uri);
                        Context context=NewDataActivity.this.getApplicationContext();
...
//                }
                try {
                    URL url = new URL("http://111.231.62.68/Required_data/1/SH_Spe_list/");
                    HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                    urlConnection.setConnectTimeout(5 * 1000);
                    urlConnection.setReadTimeout(5 * 1000);
...
//                    Log.v("x",point[0].toString());
    ...
    private void showPic1(){
        ...
        credits.setHref("http://111.231.62.68/Required_data/1/SH_Acc_list/");
        credits.setText("http://111.231.62.68/Required_data/1/SH_Acc_list/");
...
//        hiyAxis.setMin(0);
        ...
        options2.setSeries(new ArrayList<HISeries>(Collections.singletonList(line1)));
        HITooltip tooltip=new HITooltip();
        tooltip.setValueDecimals(3);
